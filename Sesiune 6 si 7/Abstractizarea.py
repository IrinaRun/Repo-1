'''
ABSTRACTIZAREA - implica izolarea unei entitati pentru a evidentia doar caracteristicile relevante si a ascunde
detaliile de implementare. Reprezinta crearea a ceea ce putem numi un tipar pentru celelate clase astfel incat oricare
clasa care va veni si va mosteni clasa abstracta va fi obligata sa implementeze metodele abstracte definite in acea clasa
...
b) metode abstracte (@abstractmethod)- sunt metode definite in clasele abstracte, dar nu au implementare. Acestea sunt
implementate in clasele copil
'''
