'''
Encapsulare - este posibilitatea de a restrictiona accesul la anumite atribute si metode dintr-o clasa astfel incat sa
protejam datele,sa aratam utilizatorului doar informatiile de care are nevoie. Motivul pentry care vrem sa facem asta
este fie din motive de securitate fie pentru a controla modificarea de catre utilizator
Exista trei tipuri :
a) public (fara restrictii) =atributul sau metoda sunt accesibile oriunde in program
b) private - atributele si metodele sunt accesibile doar in interiorul clasei in care au fost definite. Vor fi precedate
 de caracterul "__"
c) protected - atributele sau metodele sunt vizibile oriunde dar nu sunt returnate ca sugestii. Vor fi precedate de
 caracterul "_"
'''
...
# Atunci cand avem de a face cu atribute private (mai ales) sau protected, de regula se definesc ceea ce se numeste :
# getter - metoda pentru extragere valori din atribut
# setter - metoda pentru actualizare valori in atribut
# deleter - metoda pentru stergere valori din atribut
...
cinema_afi.floricele = 50           # creem un atribut nou specific doar obiectului cinema_afi, acesta nu poate fi
                                    # folosit de alte obiecte
